public class CreditCard {
  ...
  public boolean charge(double price) { // make a charge
    ...
    return true; // at this point, the charge is successful
  }
  ...
  public static void main(String[] args) {
    ...
    PredatoryCreditCard card = new PredatoryCreditCard("John Bowman", "California Savings", "5391 0375 9387 5309", 5000,
        300, 1.2);
    System.out.println();
    printSummary(card);
  }
